...
El estudio de [@piwowar2019] demuestra que desde la década de los 90 ha habido un aumento constante de publicaciones que se adscriben al Open Access, y si bien el fenómeno se desarrolla en mayor medida dentro de las ciencias exactas, las ciencias sociales no se quedan atrás y le siguen el paso[@swan2013]. Según [@hernández2016], los beneficios atribuídos a las prácticas científicas de carácter abierto no difieren sobre la disciplina y traen consigo efectos positivos ligados a:
...
Muchos se preguntarán *¿Qué tipo de documentos puedo publicar en acceso abierto?* Y la respuesta va desde pre y post-print, bases de datos y softwares. En cuanto a las primeras dos, desde UNESCO (2013) se definen dos rutas principales o bien, tipos de repositorios donde depositar publicaciones con el rótulo de **OA** (Dorado y Verde), pero en la práctica se pueden diferenciar en cinco según [@piwowar2019] y [@universoabierto2019]:
...
```{r fp, echo=FALSE, fig.cap="Piwowar, H. et al.(2019). The Future of OA: A large-scale analysis projecting Open Access publication and readership. bioRxiv 795310; doi: https://doi.org/10.1101/795310", fig.align = 'center', out.width = '100%'}
knitr::include_graphics(path = "https://www.biorxiv.org/content/biorxiv/early/2019/10/09/795310/F1.large.jpg")
```

### ResearchGate y Academia.edu: ¿Plataformas de aceso abierto?

De seguro conoces las plataformas de *ResearchGate y Academia.edu* o quizás en alguna ocasión has recurrido a estas páginas para compartir tus publicaciones o descargar archivos científicos para uso personal. Sin embargo, hay que mencionar que estas plataformas no son un ejemplo de *Open Acess* debido a que funcionan como redes sociales similares a *Facebook o LinkedIn*, pues su objetivo es crear redes de contactos entre colegas e investigadores con intereses afines, quienes comparten copias de sus productos científicos. Según [@fortney12], *ResearchGate y Academia.edu* al ser empresas con fines de lucro no cumplen con la característica principal que comparten los repositorios de *Aceso Abierto*, pues estos son administrados por universidades, agencias gubernamentales, asociaciones internacionales u cualquier otro organismo sin fines de lucro, cuyo objetivo se centra en poner los conocimientos al servicio público.
