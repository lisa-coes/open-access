...
1.  La constitución del internet y las nuevas tecnologías como el medio para la divulgación científica permitió abaratar costos de impresión y acelerar el transporte de conocimientos.
...
El estudio de [@piwowar_future_2019] demuestra que desde la década de los noventa ha habido un aumento constante de publicaciones que se adscriben al Open Access, y si bien el fenómeno se desarrolla en mayor medida dentro de las ciencias exactas, las ciencias sociales no se quedan atrás y le siguen el paso [@swan_directrices_2013]. Según [@hernandez_por_2016], los beneficios atribuídos a las prácticas científicas de carácter abierto no difieren sobre la disciplina y traen consigo efectos positivos ligados a:
...
## ¿Cómo se publica en open access?

Muchos se preguntarán *¿Qué tipo de documentos puedo publicar en acceso abierto?* Y la respuesta es amplia pues se pueden publicar pre-prints, post-print, bases de datos y softwares. En cuanto a las primeras dos, [@swan_directrices_2013] - representante de UNESCO - define dos rutas principales o bien, tipos de repositorios donde depositar publicaciones con el rótulo de **OA** (Dorado y Verde), pero en la práctica se pueden diferenciar en cinco. Según [@universoabierto_rutas_2019] sus principales características son:
...
Table: (\#tab:tab_1)Tabla comparativa del uso de SocArXiv versus otros sitios
