...
<p class="caption">(\#fig:FutureOA) El futuro de OA: un análisis a gran escala que proyecta la publicación y los lectores de acceso abierto. Traducción propia en base a Piwowar, H. et al. (2019).</p>
</div>
...
Table: (\#tab:tab1)Tabla comparativa del uso de SocArXiv versus otros sitios
