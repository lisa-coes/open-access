...
Table: (\#tab:tab_3)Descripción de Revistas
...
> La Internet ha cambiado fundamentalmente las realidades prácticas y económicas relacionadas con la distribución del conocimiento científico y el patrimonio cultural [@bethesda_declaracion_2003]
...
Table: (\#tab:unnamed-chunk-4)Fluctuación del precio en dolares del APC en las principales revistas científicas
