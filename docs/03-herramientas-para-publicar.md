...
<img src="docs/images/flujo_lisa.png" alt="Guía paso a paso para publicar libre (Elaboración propia)." width="100%" />
<p class="caption">(\#fig:unnamed-chunk-1)Guía paso a paso para publicar libre (Elaboración propia).</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="docs/images/nature_preprints.png" alt=" R. J. Abdill &amp; R. Blekhman (2019). Destino final de los Preprint (Traducción propia)." width="75%" />
<p class="caption">(\#fig:unnamed-chunk-2) R. J. Abdill & R. Blekhman (2019). Destino final de los Preprint (Traducción propia).</p>
</div>

Para el caso de las ciencias sociales, el servicio de pre-print que recomendamos utilizar es [SocArxiv](https://socopen.org/){target="_blank"} y particularmente para la discilina de la psicología [PsyArxiv](https://psyarxiv.com/){target="_blank"}. Estos servicios permiten subir archivos PDF desde la plataforma [OSF (Open Science Framework)](https://help.osf.io/hc/en-us/categories/360001530554-Preprints){target="_blank"} - un software de código abierto que permite la reproducibilidad de los procesos - y de este modo se obtiene el beneficio de acceder a un DOI (Identificador de Objeto Digital) que asegure su correcta citación. Ambos repositorios son extensiones de [ArXiv](https://arxiv.org/){target="_blank"}, la plataforma pionera de acceso abierto que en la actualidad alberga alrededor de dos millones de artículos categorizados en ocho áreas temáticas. ArXiv no posee tarifas asociadas a la publicación de los artículos, puesto a que los documentos se someten a un proceso de clasificación y no a una revisión por pares. 
...
<div class="figure" style="text-align: center">
<img src="docs/images/colores_sherpa.png" alt="Etiquetas de colores de Sherma Romeo según tipo de acceso abierto (Elaborción propia)." width="75%" />
<p class="caption">(\#fig:unnamed-chunk-3)Etiquetas de colores de Sherma Romeo según tipo de acceso abierto (Elaborción propia).</p>
</div>
...
Table: (\#tab:tab3)Descripción de Revistas

|Revista                                       |País     |Área Temática     |Asunto Categoría           |Link                                                                      |
|:---------------------------------------------|:--------|:-----------------|:--------------------------|:-------------------------------------------------------------------------|
|Qualitative Sociology Review                  |Polonia  |Ciencias Sociales |Ciencias Sociales diversas |http://www.qualitativesociologyreview.org/ENG/index_eng.php (Open Access) |
|The International Journal Qualitative Methods |Canadá   |Ciencias Sociales |Educación                  |https://journals.sagepub.com/home/ijq (Open Access)                       |
|Forum Qualitative Sozialforscung              |Alemania |Ciencias Sociales |Ciencias Sociales diversas |https://www.qualitative-research.net/index.php/fqs (Open Access)          |
...
Table: (\#tab:tab2)Fluctuación del precio en dolares del APC en las principales revistas científicas
