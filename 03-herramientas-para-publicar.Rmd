...
```{r, echo=FALSE, fig.cap="Guía para publicar libre (Elaboración propia).", fig.align = 'center', out.width = '100%'}
...
```{r, echo=FALSE, fig.cap=" R. J. Abdill & R. Blekhman (2019). Preprint en bioRxiv https://doi.org/10.1101/515643 (Traducción propia)", fig.align = 'center', out.width = '75%'}
