...
```{r, echo=FALSE, fig.cap="XXXXX", fig.align = 'center', out.width = '80%'}
...
```{r tabtax, echo=FALSE}
knitr::kable(tab_2, col.names = c("Repositorio","APC mínimo","APC máximo","¿OA o Híbrido?"), caption = "Fluctuación del APC en principales revistas científicas") %>%
...
```{r, echo=FALSE, fig.cap="Tips para conservar los derechos de autor. Imagen de Biblioteca CRAI - Universidad Pablo de Olavide", fig.align = 'center', out.width = '80%'}
