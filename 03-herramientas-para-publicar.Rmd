...
tab_3 <- read.csv(file = "tabla_3.csv",header = 1,sep = ";",encoding = "UTF-8")
```

```{r tab_3, echo=FALSE}
knitr::kable(tab_3, col.names = c("Revista","País","Área Temática","Asunto Categoría","Link"), caption = "Descripción de Revistas") %>%
